...
base_search_task_fields = {
    ...
    'options.site_capture': fields.Boolean(description="是否开启站点截图"),
    'options.test_add_new': fields.Boolean(description="是否开启测试服务"),
    'options.whatweb': fields.Boolean(description="是否开启whatweb服务")
...
add_task_fields = ns.model('AddTask', {
    ...
    'test_add_new': fields.Boolean(),
    'whatweb': fields.Boolean(),
})
