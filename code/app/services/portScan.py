...
class PortScan:
    def __init__(self, targets, ports=None, service_detect = False, os_detect = False):
        ...
        self.nmap_arguments = "-sS -n -PE -PS{} --script-args http.useragent=\"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:83.0) Gecko/20100101 Firefox/83.0\" --open".format(self.alive_port)
